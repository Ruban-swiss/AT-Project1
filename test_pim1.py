...
class Test_Pim1:
    ...
    def test_PIM1 (self):
            try:
                ...
                #edit the driving license
                wait.until(EC.presence_of_element_located((By.XPATH, locators.Locators.xpath2))).send_keys("56899")

                #click on the save
                self.driver.find_element(by=By.XPATH, value=locators.Locators.xpath3).click()
